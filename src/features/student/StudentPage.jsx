...
import { StudentSchedule } from './components/StudentViews'
import {
...
const enrolledCourses = [
  { code: 'CS101', title: 'Foundations of Software Development Environment', faculty: 'Dr. Aisha Patel', schedule: 'Mon/Wed 10:00–11:30', room: 'Hall 204', progress: 72, grade: 'A', credits: 2 },
  { code: 'CS102', title: 'Web Development (Part-1: HTML, Part-2: CSS)', faculty: 'Prof. Suresh Gopi', schedule: 'Tue/Thu 14:00–15:30', room: 'Lab 101', progress: 65, grade: 'A-', credits: 2 },
  { code: 'CS103', title: 'UI Development with Web Frameworks (Bootstrap)', faculty: 'Dr. Arun Kumar', schedule: 'Mon/Fri 12:00–13:00', room: 'Lab 102', progress: 80, grade: 'B+', credits: 2 },
  { code: 'CS104', title: 'Introduction to Programming (JavaScript)', faculty: 'Dr. Aisha Patel', schedule: 'Fri 09:00–12:00', room: 'Seminar Room 3', progress: 58, grade: 'A', credits: 2 },
]
  ...
  return (
    <div style={{ padding: '28px 28px 48px' }}>
      ...
      <div style={{ marginBottom: 24, display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
        <div>
          <div style={{ fontSize: 11, color: 'var(--success)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 4 }}>B.Tech CSE · School of Technology & AI (Year 1)</div>
