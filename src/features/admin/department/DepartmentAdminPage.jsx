...
const faculty = [
  ...
  { name: 'Prof. Suresh Gopi', title: 'Assoc. Prof.', courses: ['CS301', 'CS304'], students: 142, rating: 4.6, status: 'active' },
  { name: 'Dr. Kavya Iyer', title: 'Asst. Prof.', courses: ['CS101', 'CS102'], students: 188, rating: 4.7, status: 'active' },
...
const contentReview = [
  ...
  { title: 'Algorithm Complexity Problem Set', submittedBy: 'Prof. Suresh Gopi', course: 'CS201', status: 'pending', time: '3h ago' },
  { title: 'OS Lab Manual — Module 4', submittedBy: 'Dr. Kavya Iyer', course: 'CS202', status: 'review', time: '6h ago' },
]
...
export default function DepartmentAdminDashboard() {
  ...
  return (
    <div style={{ padding: '28px 28px 48px' }}>
      ...
      {/* Student Progress by Cohort + Calendar */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14, marginBottom: 14 }}>
        <Card style={{ padding: '20px 20px 12px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 14 }}>
          <div>
